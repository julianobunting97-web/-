...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(255,123,0,0.2) 0%, rgba(255,255,255,0.04) 100%)'
...
function ProfileCardComponent({
  ...
  const tiltEngine = useMemo(() => {
    ...
    const setVarsFromXY = (x, y) => {
      ...
      Object.entries(properties).forEach(([key, val]) => wrap.style.setProperty(key, val))
    }
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(255, 123, 0, 0.42)',
